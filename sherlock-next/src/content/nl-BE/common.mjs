// nl-BE market: the words every page shares. Written for Flemish SME owners, not translated.
export default {
  logoAlt: 'Sherlock SEO Agency, naar de startpagina',
  skip: 'Naar de inhoud',
  menu: 'Menu',
  ...
  footer: {
    ...
    base: { left: '© 2026 Sherlock SEO Agency', right: 'Preview: niet publiek, niet geïndexeerd' },
  },
};
