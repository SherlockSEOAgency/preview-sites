    ...
    <div class="contact-grid">
      <div class="c-form">
        <form class="form" data-preview-form aria-describedby="form-note">
          ...
          <div class="field"><label for="f-question">Quelle est votre question de croissance ?</label><textarea id="f-question" required placeholder="Par exemple : nos campagnes tournent, mais nous ne savons pas lesquelles nous amènent des clients."></textarea></div>
          ...
          <div class="submit"><button class="btn btn-primary" type="submit">Envoyer votre question</button></div>
      ...
      <div class="c-next">
        <div class="next-steps">
          ...
          <ol class="steps">
            ...
            <li><span class="st-name">Une proposition</span><span class="st-text">Ce que nous faisons, quand c’est terminé et ce que cela coûte.</span></li>
          </ol>
        </div>
      </div>
    </div>
